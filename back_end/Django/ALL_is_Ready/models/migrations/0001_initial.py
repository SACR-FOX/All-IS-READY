# Generated by Django 3.2.7 on 2022-03-31 13:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='File',
            fields=[
                ('UID', models.IntegerField(default=-1, verbose_name='所属用户ID')),
        ...
        migrations.CreateModel(
            name='Schedule',
            fields=[
                ('ScheduleID', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('UID', models.IntegerField(verbose_name='所属用户ID')),
                ('OrgID', models.IntegerField(default=-1, verbose_name='所属组织ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('OrgID', models.IntegerField(default=-1, verbose_name='组织ID')),
                ('UID', models.IntegerField(verbose_name='所属用户ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('OrgID', models.IntegerField(default=-1, verbose_name='组织ID')),
                ('STUID', models.IntegerField(default=-1, verbose_name='学号')),
                ('Rank', models.IntegerField(default=0, verbose_name='等级')),
                ('Header', models.ImageField(default='/static/img/header_default.png', upload_to='userHeader', verbose_name='用户头像')),
                ('EXP', models.IntegerField(default=0, verbose_name='用户经验值')),
            ],
            options={
                'verbose_name': '用户',
